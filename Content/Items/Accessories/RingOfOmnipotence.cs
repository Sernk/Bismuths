...
namespace Bismuth.Content.Items.Accessories
{
    public class RingOfOmnipotence : ModItem
    {
        ...
        {
            string DivineEquipment = this.GetLocalization("TooltipLine2.DivineEquipment").Value; // Ru: Божественная экипировка En: Divine Equipment
            string RingOfOmnipotence = this.GetLocalization("TooltipLine2.RingOfOmnipotence").Value; // Ru: Увеличивает все виды урона на 3% En: All types of damage are increased by 3%
            string RingOfOmnipotence1 = this.GetLocalization("TooltipLine2.RingOfOmnipotence1").Value; // Ru: Увеличивает все виды урона на 7%, увеличивает \nмаксимальный запас здоровья на 15
                                                                                                       // En: All types of damage are increased by 7%, +15 HP
            string RingOfOmnipotence2 = this.GetLocalization("TooltipLine2.RingOfOmnipotence2").Value; // Ru: Увеличивает все виды урона на 10%, увеличивает \nмаксимальный запас здоровья на 25, восстановление здоровья \nна 8 ед/сек, увеличивает отражение урона на 8%
                                                                                                       // En: +10% for all damages, +25 HP, +1 HP/sec, damage reflection \nis increased by 8%
            string RingOfOmnipotence3 = this.GetLocalization("TooltipLine2.RingOfOmnipotence3").Value; // Ru: Увеличивает все виды урона на 13%, увеличивает \nмаксимальный запас здоровья на 50, восстановление здоровья \nна 3 ед/сек, увеличивает отражение урона на 12%, \nувеличивает шанс уклонения на 5%, увеличивает шанс критического \nудара на 10%
        ...
        {
            //DisplayName.SetDefault("One Ring");
            //Tooltip.SetDefault("Doesn't give any bonuses");
            //DisplayName.AddTranslation(GameCulture.Russian, "Кольцо Всевластия");
