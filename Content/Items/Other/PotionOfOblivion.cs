...
namespace Bismuth.Content.Items.Other
{
    public class PotionOfOblivion : ModItem
    {
        ...
        public override bool? UseItem(Player player)
        {
            ...
            /*if (player.GetModPlayer<BismuthPlayer>().SpendedPoints2 != player.GetModPlayer<BismuthPlayer>().SpendedPoints)
            {
                player.GetModPlayer<BismuthPlayer>().SkillPoints += player.GetModPlayer<BismuthPlayer>().SpendedPoints2;
            }
            else*/
