...
{
    public class ThrowersEngraving : ModItem
    {
        public override void SetStaticDefaults()
        {
            //DisplayName.SetDefault("Thrower's Engraving");
            //Tooltip.SetDefault("Use this to choose your class");
            //DisplayName.AddTranslation(GameCulture.Russian, "Гравировка метателя");
        ...
        public override bool? UseItem(Player player)
        {
            ...
            player.GetModPlayer<BismuthPlayer>().PlayerClass = 4;
            return true;
        }
