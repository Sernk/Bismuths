...
namespace Bismuth.Content.Items.Weapons.Throwing
{
    public class FuryOfWaters : ModItem
    {
        public override void SetDefaults()
        {
            ...
            Item.damage = 42;           //this is the item damage
            ...
            Item.shoot = ModContent.ProjectileType<FuryOfWatersP>();  //javelin projectile (поставь продж обратно)
        ...
        {
            //DisplayName.SetDefault("Fury Of the Waters");
            //DisplayName.AddTranslation(GameCulture.Russian, "Ярость вод");
            //Tooltip.SetDefault("Creates water quill after dealing damage");
            //Tooltip.AddTranslation(GameCulture.Russian, "Создаёт водяной лепесток после нанесения урона");
        }     
