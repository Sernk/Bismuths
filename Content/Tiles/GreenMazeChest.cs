...
{
    public class GreenMazeChest : ModTile
    {
        public override void SetStaticDefaults()
        {
            ...
            AddMapEntry(Color.Green, this.GetLocalization("MapEntry1"), MapChestName);
            DustType = 79;
        ...
        public override bool RightClick(int i, int j)
        {
            ...
            for (int k = 0; k < 58; k++)
            {
                if (player.inventory[k].type == ModContent.ItemType<GreenKey>() && player.inventory[k].stack > 0)
                {
                    keySlot = k;
                    break;
                }
        ...
        public override void MouseOver(int i, int j)
        {
            ...
            else
            {
                ...
                {
                    if (SavingOpenChests.BChest)
                    {
                        player.cursorItemIconID = ModContent.ItemType<Items.Placeable.GreenMazeChest>();
                    }
                    else
                    {
