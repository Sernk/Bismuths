...
{
    public class WaveOfForceP : ModProjectile
    {
        public override void SetStaticDefaults()
        {
            // DisplayName.SetDefault("Wave of Force");
            //DisplayName.AddTranslation(GameCulture.Russian, "Волна силы");
        ...
        public override void AI()
        {
            ...
            for (int i = 0; i < 6; i++)
            {
                ...
                Dust.NewDust(new Microsoft.Xna.Framework.Vector2(Projectile.position.X, Projectile.position.Y), Projectile.width, Projectile.height, 62);
            }
        }
