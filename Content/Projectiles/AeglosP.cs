...
{
    public class AeglosP : ModProjectile
    {
        ...
        public override void OnKill(int timeLeft)
        {
            for (int counter = 0; counter < dust_count; counter++)
            {
                ...
                int dust = Dust.NewDust(new Vector2(Projectile.position.X, Projectile.position.Y + 2f), Projectile.width, Projectile.height, DustID.Iron, 5, 5, 100, default(Color), 1.4f);
