...
{
    public class SandWaveEnemyP : ModProjectile
    {
        public override void SetStaticDefaults()
        {
            // DisplayName.SetDefault("Sand Wave");
            //DisplayName.AddTranslation(GameCulture.Russian, "Песчаная волна");
        ...
        public override void AI()
        {
            for (int i = 0; i < 6; i++)
            {
                int dust = Dust.NewDust(new Microsoft.Xna.Framework.Vector2(Projectile.position.X, Projectile.position.Y), Projectile.width, Projectile.height, 169);
